...
export const Sidebar = ({ cartItems }: SidebarProps) => {
  ...
  return (
    <div className=" border border-gray-200 bg-gray-50 px-[30px] pt-[30px] pb-[15px] w-[400px]">
      <h3 className="text-[32px] text-customDarkGray leading-[44px] tracking-[0.6px] mb-[40px]">
